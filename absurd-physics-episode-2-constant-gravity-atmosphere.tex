...
The discussion that follows is intentionally idealized. We focus on a simplified model---constant downward gravity, an ideal gas, and a tractable atmospheric structure---so that we can isolate the consequences of this one strange feature of the world without getting lost in every complication at once.
