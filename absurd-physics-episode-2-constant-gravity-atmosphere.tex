...
{\fontsize{28}{34}\selectfont\bfseries What Would an Atmosphere Be Like on a World with Constant Gravity?}
...
\begin{center}
\url{https://github.com/DRosenman/advanced-experimental-physics/blob/master/absurd-physics-episode-1-infinite-flat-world-gravity.pdf}
\end{center}
...
\begin{center}
\textit{What would an atmosphere be like on such a world?}
\end{center}

The discussion that follows is intentionally idealized. We focus on a simplified model---constant downward gravity, an ideal gas, and a tractable atmospheric structure---so that we can isolate the consequences of this one strange feature of the world without getting lost in every complication at once. The key issue is not just that gravity is constant, but also how strong it is:\footnote{A question from my uncle and close friend David Johnson, a retired nuclear engineer, about how the strength of \(g\) affects the result helped motivate this point.} a larger \(g\) compresses the atmosphere more tightly, while a smaller \(g\) allows it to spread out farther.
...
So the strength of \(g\) matters in a very direct way: larger \(g\) means a smaller scale height and a more compressed atmosphere, while smaller \(g\) means a larger scale height and a more extended atmosphere.
